...
if __name__ == '__main__':
    st.header(f"Zania Agent") 

    # This is the step A for loading PDF file for chunking and indexing
    uploaded_file = st.file_uploader("Please upload your PDF file here", 
                                    type=['pdf'], 
    ...
    input_questions =  st.text_area("Please provide your questions here, use comma(,) to seperate each question.", 
                                    value="", 
                                    height=None, 
                                    max_chars=500)
